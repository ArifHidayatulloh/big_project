...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Department User</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content pb-2">
        <div class="card shadow-sm" style="border-radius: 15px;">
            <div class="card-header text-center"
                ...
                <h4 class="m-0">Edit Department User</h4>
            </div>
            <form action="/depuser/update/{{ $depUser->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <select class="custom-select form-control" id="department" name="unit_id" required>
                                    ...
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}"
                                            {{ $depUser->unit_id == $department->id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
