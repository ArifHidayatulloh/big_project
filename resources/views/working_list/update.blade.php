            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="card shadow-sm mt-4 mb-4">
                        ...
                        <div class="card-body">
                            <form action="/working-list/storeUpdatePIC/{{ $comment->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Comment Section -->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="update" name="update" class="form-control rounded" rows="4" placeholder="Write your update here..." required style="white-space: pre-wrap;"></textarea>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <a href="/working-list/{{ $comment->working_list_id }}" class="btn btn-secondary btn-lg">
